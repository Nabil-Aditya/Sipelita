                        ...
                        <div class="card-header py-3">
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active" id="pengajuan-tab" data-bs-toggle="tab" data-bs-target="#pengajuan" type="button" role="tab" aria-controls="pengajuan" aria-selected="true">PENGAJUAN</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="pelaporan-tab" data-bs-toggle="tab" data-bs-target="#pelaporan" type="button" role="tab" aria-controls="pelaporan" aria-selected="false">PELAPORAN</button>
                                </li>
                            </ul>
                        </div>
                        <div class="card-body">
                            <div class="tab-content" id="myTabContent">
                                ...
                                <div class="tab-pane fade show active" id="pengajuan" role="tabpanel" aria-labelledby="pengajuan-tab">
                                    <div class="table-responsive">
                                        <table class="table table-bordered" id="dataTablePengajuan" width="100%" cellspacing="0">
                                            <thead>
                                                <tr>
                                                    <th>Name</th>
                                                    <th>Position</th>
                                ...
                                <div class="tab-pane fade" id="pelaporan" role="tabpanel" aria-labelledby="pelaporan-tab">
                                    <div class="table-responsive">
                                        <table class="table table-bordered" id="dataTablePelaporan" width="100%" cellspacing="0">
                                            <thead>
                                                <tr>
                                                    <th>Name</th>
                                                    <th>Position</th>
