            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="add_pengajuan_pelatihan.php">Pengajuan Pelatihan</a>
                ...
                <script>
                    $(document).ready(function() {
                        ...
                        $('#pengajuanForm').on('submit', function(event) {
                            ...
                            if (!lembaga || !programStudi || !jurusan || !namaPeserta || !alamat || !tanggalKegiatan || !tanggalSelesai || !sumberDana || !kompetensi || !targetKegiatan) {
                                Swal.fire({
                                    icon: 'error',
                                    title: 'Oops...',
