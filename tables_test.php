        ...
        <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar"
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                <div class="sidebar-brand-icon">
                    ...
                    <!-- Gambar dengan border-radius 5px dan box-shadow -->
                </div>
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-indo text-uppercase mb-1">
                        ...
                        <div class="container mt-5">
                            ...
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active" id="riwayat-pengajuan-tab" data-bs-toggle="tab" data-bs-target="#riwayat-pengajuan" type="button" role="tab" aria-controls="riwayat-pengajuan" aria-selected="true">Riwayat Pengajuan</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="riwayat-pelaporan-tab" data-bs-toggle="tab" data-bs-target="#riwayat-pelaporan" type="button" role="tab" aria-controls="riwayat-pelaporan" aria-selected="false">Riwayat Pelaporan</button>
                                </li>
                            </ul>
                            ...
                            <div class="tab-content" id="myTabContent">
                                ...
                                <div class="tab-pane fade show active" id="riwayat-pengajuan" role="tabpanel" aria-labelledby="riwayat-pengajuan-tab">
                                    <div class="card shadow mb-4 mt-3">
                                        <div class="card-header py-3">
                                            <h6 class="m-0 font-weight-bold text-primary">Tabel Data Pengajuan</h6>
                                        </div>
                                        <div class="card-body">
                                            <div class="table-responsive">
                                                <table class="table table-bordered" id="dataTable1" width="100%" cellspacing="0">
                                                    <thead>
                                                        <tr>
                                                            <th>No000000</th>
                                                            <th>No Pen000gajuan</th>
                                                            <th>Tang00gal Pengajuan</th>
                                                            <th>000</th>
                                                            <th>Ak000si</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>22244790</td>
                                                            <td>2024-09-24</td>
                                                            <td><span class="text-primary">Diproses</span></td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><button class="btn btn-danger btn-sm">Ulangi</button></td>
                                                        </tr>
                                                        <tr>
                                                            <td>3</td>
                                                            <td>223344790</td>
                                                            ...
                                                            <td><button class="btn btn-success btn-sm">Lanjut</button></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                                ...
                                <!-- Tabel Riwayat Pelaporan -->
                                <div class="tab-pane fade" id="riwayat-pelaporan" role="tabpanel" aria-labelledby="riwayat-pelaporan-tab">
                                    <div class="card shadow mb-4 mt-3">
                                        <div class="card-header py-3">
                                            <h6 class="m-0 font-weight-bold text-primary">Tabel Data Pelaporan</h6>
                                        </div>
                                        <div class="card-body">
                                            <div class="table-responsive">
